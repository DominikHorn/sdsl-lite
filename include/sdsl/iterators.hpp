...
*/
/*! \file iterators.hpp
    \brief iterators.hpp contains an generic iterator for random access
   containers. \author Simon Gog
*/
...
inline typename random_access_const_iterator<t_rac>::difference_type operator-(
    ...
    const random_access_const_iterator<t_rac>& y) {
  return (typename random_access_const_iterator<t_rac>::difference_type)
             x.m_idx -
         (typename random_access_const_iterator<t_rac>::difference_type)y.m_idx;
}

template <class t_rac>
inline random_access_const_iterator<t_rac> operator+(
    typename random_access_const_iterator<t_rac>::difference_type n,
...
struct random_access_container {
  using iterator_type = random_access_const_iterator<random_access_container>;
  using size_type = int_vector<>::size_type;
  using difference_type = int_vector<>::difference_type;
  using value_type = std::invoke_result<t_F(size_type)>;
